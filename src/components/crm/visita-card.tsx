    ...
    >
      ...
      <div className="flex items-start gap-4 flex-1 w-full min-w-0">
        ...
        <div className="shrink-0">
          <div className="bg-orange-50 border border-orange-200 rounded-xl px-3 py-2 min-w-[60px] text-center shadow-sm">
            {showDate && visita.data_visita ? (
              <div className="flex items-center gap-1.5 justify-center">
                ...
                <span className="text-sm font-black text-orange-600 font-mono leading-none">
                  {(visita.horario || '').substring(0, 5) || '—'}
                </span>
                <span className="text-[8px] text-orange-400 font-semibold leading-none">hs</span>
              </div>
            ) : (
              <div className="flex flex-col items-center">
                ...
                <p className="text-[8px] text-orange-400 font-semibold mt-0.5">hs</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0 space-y-1.5">
          ...
          <div className="space-y-1.5 mt-2">
            <p className="text-xs text-gray-700 flex items-center gap-1 leading-none">
              <span className="font-semibold text-gray-500">Instalador:</span>
              <span className="font-bold text-gray-800">"{tecnicoNome || 'A definir'}"</span>
            </p>
            ...
            {visita.agendado_por && (
              <div className="flex items-center gap-1.5 mt-1">
                ...
                <span className="text-[11px] font-bold text-indigo-700 bg-indigo-50/80 border border-indigo-100 px-2 py-0.5 rounded-md break-words leading-none">
