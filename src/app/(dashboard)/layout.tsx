        ...
        <aside className="w-full md:w-64 bg-slate-900 border-r border-slate-800 p-6 flex flex-col justify-between">
          <div className="space-y-8">
            ...
            <nav className="flex flex-col space-y-2">
              <a
                href="/visitas"
                className="px-4 py-2.5 rounded-lg text-sm font-medium bg-slate-950 border border-orange-500/20 text-orange-400 flex items-center gap-2 transition-all"
              >
              ...
              <div className="px-4 py-2.5 rounded-lg text-sm font-medium text-slate-500 flex items-center gap-2 cursor-not-allowed">
                ...
                Gestão de Leads
                <span className="text-[10px] bg-slate-950 px-1.5 py-0.5 rounded text-slate-600 border border-slate-800 ml-auto">Breve</span>
              </div>
              <div className="px-4 py-2.5 rounded-lg text-sm font-medium text-slate-500 flex items-center gap-2 cursor-not-allowed">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
